export function PixelFooter() {
	return (
		<footer className="relative overflow-hidden border-foreground border-t-4 bg-primary p-4 text-center dark:bg-slate-900">
			...
			<p className="retro relative z-10 text-primary-foreground text-xs md:text-sm dark:text-foreground">
				© 2023 Chattini Archives{" "}
				<span className="mx-2 text-accent dark:text-accent">•</span>
